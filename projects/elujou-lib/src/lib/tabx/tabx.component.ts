...
import { Motle1Component } from '../motle1/motle1.component';
...
@Component({
  ...
  imports: [Yld1Component, HetkavaComponent, Yld2Component, Yld3Component, Yld4Component,  Graaf10Component, Yld6Component, Varav3Component, Varav4aComponent, Varav5Component, Varav6Component, Varav7Component, Varav8Component, Varav9Component, Varav10Component, Hetk1Component, Hetk3Component, KonsultantComponent, KonsultantAvaComponent, KonsultantInfoComponent, VarvidComponent, Motle1Component, MettextComponent, MetlouadComponent]
})
